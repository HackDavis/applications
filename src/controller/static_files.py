...
static_path = os.path.join('applications-frontend', 'dist')


# redirect initial homepage requests to static files controller
@static_files.route('/', methods=['GET'], defaults={'path': 'index.html'})
